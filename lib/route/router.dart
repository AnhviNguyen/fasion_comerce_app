...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case productDetailsScreenRoute:
      ...
      case productByCategoriesScreenRoute:
      final category_detail = settings.arguments as Category;
      return MaterialPageRoute(
        builder: (context) {
          print(category_detail);
          return ProductByCategoryScreen(category: category_detail);
        },
      );
